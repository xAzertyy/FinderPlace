...
<body
    class="<?php echo (preg_match('/Mobile|Android|iPhone|iPad/', $_SERVER['HTTP_USER_AGENT']) ? 'mobile' : 'desktop'); ?>">    <h1 align="center">Aggiungi i dati-marker al Database</h1>
    <table align="center">
        <tr>
            <td>
                <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                    <form id="agg" style="padding:2vh;" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">


                        <div style="padding:2vh;" class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping"><b>Nome attività</b></span>
                            <input type="text" name="Nome" class="form-control" placeholder="inserisci nome..." aria-describedby="addon-wrapping"><br>
                        </div>
                        ...
                        <div style="padding:2vh;" class="input-group">
                            <span class="input-group-text"><b>Descrizione</b></span>
                            <textarea class="form-control" id="desc" name="descrizione" rows="1"></textarea>
                        </div>

                        <div style="padding:2vh;" class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping"><b>Tipologia</b></span>
                        ...
                        <div style="padding-left:2vh;" id="pre_btt">
