...
--
-- Host: 127.0.0.1
-- Creato il: Apr 22, 2024 alle 20:53
...
(2, 'Caprice ', 'Bakery', 37.3217, 23.2323),
(3, 'Caprice', 'Pizzeria', 37.3217, 13.6671),
(4, 'Caprice', 'Fast Food', 37.3217, 13.6671),
(5, 'Caprice', 'Fast Food', 37.3217, 13.6671),
(6, 'Caprice', 'Reasturant', 37.3217, 13.6671),
(7, 'Très Chich', 'Pizzeria', 37.3217, 13.6671),
(8, 'Très Chich', 'Bakery', 37.3217, 13.6671),
(10, 'LSLSLSL', 'Cafè', 37.3217, 23.2323),
(11, 'Caprice', 'Bakery', 37.3217, 13.6671),
(12, 'Caprice', 'Cafè', 37.3217, 13.6671);
...
--
ALTER TABLE `locations`
  MODIFY `ID_pos` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
